package com.parceldelivery.delivery.security.filter;
...
import static com.parceldelivery.commonutil.security.JwtUtils.getUserNameAndRolesFromJwtToken;
...
public class PreAuthenticatedUserRoleHeaderFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(@NonNull HttpServletRequest request,
        ...
        try {
            ...
            if (token != null) {
                Pair<String, List<String>> userDetails = getUserNameAndRolesFromJwtToken(token, secret);
